...
// ─── 工器具选择 — 个人防护 ───
import blueSafetyHelmet from '@/assets/images/tool-selection/BlueSafetyHelmet.png'
import cottonGloves from '@/assets/images/tool-selection/CottonGloves.png'
import electricalInsulatingShoes from '@/assets/images/tool-selection/ElectricalInsulatingShoes.png'
import leatherShoes from '@/assets/images/tool-selection/LeatherShoes.png'
import motorcycleHelmet from '@/assets/images/tool-selection/MotorcycleHelmet.png'
import redSafetyHelmet from '@/assets/images/tool-selection/RedSafetyHelmet.png'
import rubberGloves from '@/assets/images/tool-selection/RubberGloves.png'
import safetyGoggles from '@/assets/images/tool-selection/SafetyGoggles.png'
import sandal from '@/assets/images/tool-selection/Sandal.png'
import tShirtAndShorts from '@/assets/images/tool-selection/TShirtAndShorts.png'
import workClothes from '@/assets/images/tool-selection/WorkClothes.png'
import workClothesTopAndJeans from '@/assets/images/tool-selection/WorkClothesTopAndJeans.png'
