        ...
        <el-form ref="formRef" :model="formData" @change="handleUserOperation" class="paper-form">
            ...
            <div class="paper-header">
                ...
                <span class="inline-input">
                    <el-input v-model="formData.company" placeholder="______" size="default"
                        @input="handleUserOperation" />
                </span>
            ...
            <div class="form-line-row triple">
                ...
                <div class="form-line">
                    ...
                    <span class="inline-input">
                        <el-input v-model="formData.member1" placeholder="________" size="default"
                            @input="handleUserOperation" />
                    </span>
                </div>
                <div class="form-line">
