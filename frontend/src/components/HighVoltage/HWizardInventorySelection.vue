    ...
    <div class="steps-wrapper">
      <div class="steps-bar">
        ...
        >
          ...
          <div class="step-info">
            <el-icon class="step-icon"><component :is="cat.icon" /></el-icon>
          ...
          <div class="header-left">
            ...
            <div>
              ...
              <div class="header-desc">
                ...
                <span v-if="currentCategory.requiredCount !== undefined && currentCategory.requiredCount !== null">
      ...
      <div class="error-dialog-body">
        ...
        <div class="error-list">
          ...
          >
            ...
            <el-icon class="error-goto"><Right /></el-icon>
          </div>
        </div>
      </div>
      <template #footer>
...
@keyframes pulse-error {
  0%, 100% { box-shadow: 0 4px 12px rgba(245, 108, 108, 0.35); }
  50% { box-shadow: 0 4px 20px rgba(245, 108, 108, 0.55); }
}
...
@keyframes wrongPulse {
  ...
  25% { border-color: #f89898; transform: translateX(-3px); }
  50% { border-color: #f56c6c; transform: translateX(3px); }
  75% { border-color: #f89898; transform: translateX(-2px); }
  100% { border-color: #f56c6c; transform: translateX(0); }
}
